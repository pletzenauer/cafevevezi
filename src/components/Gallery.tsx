      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 border border-text/20 text-text text-sm tracking-widest uppercase hover:border-accent hover:text-accent transition-colors duration-300"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
